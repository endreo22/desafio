            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="text-right mt-2 mr-4">
                        <a href="{{"branches/create"}}" class="btn btn-success">Cadastrar</a>
                    </div>
                    <div class="card-body">
                        @csrf
                        <table class="table text-center">
                            ...
                            @foreach($fili as $filis)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{url("branches/$filis->id")}}">
                                            <button class="btn btn-dark">Ver</button>
                                        </a>
                                        <a href="{{url("branches/$filis->id/edit")}}">
                                            <button class="btn btn-primary">Editar</button>
                                        </a>
                                        <a href="{{url("branches/$filis->id")}}" class="js-del">
